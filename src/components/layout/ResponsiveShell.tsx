...
export function ResponsiveShell({ sidebar, children }: ResponsiveShellProps) {
  ...
  return (
    <div className="relative min-h-screen bg-[#02030a] text-white">
      ...
      <div className="relative z-10 flex min-h-screen flex-col lg:flex-row">
        <aside className="hidden lg:flex lg:w-[320px] lg:flex-shrink-0">
          {sidebar}
        </aside>

        <main className="relative flex-1">
          <div className="planjo-grid" aria-hidden />
          <header className="lg:hidden sticky top-0 z-20 flex items-center justify-between gap-3 bg-[#02030a]/80 px-4 py-4 backdrop-blur-2xl">
